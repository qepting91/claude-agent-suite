...
class TestEndToEndBuild:
    ...
    def test_complete_build_workflow(
        self, temp_project_dir, valid_config, valid_template, skill_file, monkeypatch
    ):
    ...
    def test_build_with_skill_includes(
        self, temp_project_dir, valid_config, template_with_includes, skill_file, monkeypatch
    ):
    ...
    def test_build_with_bash_validation(
        self, temp_project_dir, valid_config, template_with_bash_blocks, monkeypatch
    ):
    ...
    def test_build_with_dangerous_commands_warning(
        ...
        dangerous_commands_config, monkeypatch, capsys
    ):
    ...
    def test_oversized_template_fails_validation(
        self, temp_project_dir, valid_config, oversized_template, monkeypatch
    ):
...
class TestBuildVariableSubstitution:
    ...
    def test_build_timestamp_present(
        self, temp_project_dir, valid_config, monkeypatch
    ):
...
class TestCLIOptions:
    ...
    def test_verbose_mode_shows_paths(
        self, temp_project_dir, valid_config, valid_template, monkeypatch, capsys
    ):
